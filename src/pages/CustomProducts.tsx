        ...
        <div className="container-custom max-w-4xl mx-auto">
          <div className="bg-white p-8 rounded-2xl shadow-xl border">
            ...
            <div className="space-y-6 mb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                That's where Ridge Valley's custom packaging solutions transform your business trajectory. We don't just create containers—we engineer brand experiences that turn every shipment into a powerful marketing moment. Our design philosophy combines cutting-edge aesthetics with functional excellence, ensuring your packaging becomes an extension of your product's story.
              </p>
              
              <div className="bg-gradient-to-r from-ridge-gold/10 to-ridge-gold/5 border border-ridge-gold/20 rounded-lg p-6">
